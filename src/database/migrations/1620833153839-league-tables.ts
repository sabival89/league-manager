...
export class leagueTables1620833153839 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "league"."person_role_enum" AS ENUM('captain', 'coach', 'defender', 'striker', 'keeper', 'midfielder')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "league"."team_status_enum" AS ENUM('active', 'inactive')`,
    );
    await queryRunner.query(
      `CREATE TABLE "league"."team" ("id" uuid NOT NULL, "name" character varying NOT NULL, "coach" uuid NOT NULL, "captain" uuid, "status" "league"."team_status_enum" NOT NULL DEFAULT 'inactive', CONSTRAINT "UQ_a0018d2d94d86ef05d858d032f1" UNIQUE ("name"), CONSTRAINT "REL_229a6f75d8d2f13a73936ea2d8" UNIQUE ("coach"), CONSTRAINT "REL_b060b9954ab36b76cb5d23a290" UNIQUE ("captain"), CONSTRAINT "PK_814bf8fc899e0b812d811d3d2ea" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "league"."match_location_enum" AS ENUM('spain', 'paris', 'italy', 'brazil', 'japan', 'korea')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "league"."match" ADD CONSTRAINT "FK_493731f98732f18ce01040d080c" FOREIGN KEY ("away") REFERENCES "league"."team"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "league"."match" DROP CONSTRAINT "FK_493731f98732f18ce01040d080c"`,
    );
    await queryRunner.query(
      `ALTER TABLE "league"."match" DROP CONSTRAINT "FK_3d22c730699b987b1bd187a9140"`,
    );
    await queryRunner.query(
      `ALTER TABLE "league"."team" DROP CONSTRAINT "FK_b060b9954ab36b76cb5d23a290b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "league"."team" DROP CONSTRAINT "FK_229a6f75d8d2f13a73936ea2d89"`,
    );
    await queryRunner.query(
      `ALTER TABLE "league"."person" DROP CONSTRAINT "FK_e6fcff0f5d3c939a36c71e9e420"`,
    );
